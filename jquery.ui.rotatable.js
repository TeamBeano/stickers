...
$.widget("ui.rotatable", $.ui.mouse, {
    ...
    startRotate: function(event) {
		...
		if (event.type == "touchstart") {
			var touch = event.originalEvent.touches[0] || event.originalEvent.changedTouches[0];
			 var startXFromCenter = touch.pageX - center[0];
       		 var startYFromCenter = touch.pageY - center[1];
		} else {
        ...
        $(document).bind('mouseup touchend', this.listeners.stopRotate);
    ...
    stopRotate: function(event) {
        ...
        $(document).unbind('mouseup touchend', this.listeners.stopRotate);
    ...
    getRotateAngle: function(event){
		...
		if (event.type == "touchmove") {
			var touch = event.originalEvent.touches[0] || event.originalEvent.changedTouches[0];
			 var xFromCenter = touch.pageX - center[0];
       		 var yFromCenter = touch.pageY - center[1];
		} else {
